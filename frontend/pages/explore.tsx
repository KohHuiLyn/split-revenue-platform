...
export default function Explore() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#0a0e27] via-[#0f1435] to-[#1a1f3f] text-white">
      ...
      <div className="pointer-events-none absolute top-0 right-0 w-[800px] h-[800px] bg-[#00d4ff] opacity-5 blur-[150px] rounded-full" />
      <div className="pointer-events-none absolute bottom-0 left-0 w-[600px] h-[600px] bg-[#9b4dca] opacity-5 blur-[150px] rounded-full" />
