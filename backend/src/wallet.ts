...
import { Ed25519PrivateKey, Ed25519Account, AccountAddress, PrivateKey, PrivateKeyVariants } from "@aptos-labs/ts-sdk";
...
export function getAccountFromEncrypted(encryptedPrivateKey: string): Ed25519Account {
  ...
  const aip80PrivateKey = PrivateKey.formatPrivateKey(privateKeyHex, PrivateKeyVariants.Ed25519);
